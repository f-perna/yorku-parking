...
public class PaymentTest {
    ...
    void setUp() {
        ...
        payment = new Payment(5.0, booking, new Debit(), Payment.PaymentType.DEPOSIT);
    }
    ...
    void testDefaultConstructorSetsFields() {
        ...
        assertTrue(payment.getMethod() instanceof Debit, "Payment method should be Debit");
    ...
    void testCsvConstructorWithPaymentsCsv() {
        ...
        Payment csvPayment = new Payment(paymentId, booking, 5.0, new Debit(), 
        ...
        assertTrue(csvPayment.getMethod() instanceof Debit, "Method should be Debit");
    ...
    void testSetPaymentMethod() {
        PaymentMethod creditMethod = new Credit(); 
    ...
    void testGenerateMethod() {
        assertTrue(Payment.generateMethod("Debit") instanceof Debit, "Should generate Debit method");
        assertTrue(Payment.generateMethod("Credit") instanceof Credit, "Should generate Credit method");
        assertTrue(Payment.generateMethod("Mobile") instanceof Mobile, "Should generate Mobile method");
        assertTrue(Payment.generateMethod("Cash") instanceof Cash, "Should generate Cash method");
        assertTrue(Payment.generateMethod("Unknown") instanceof Credit, "Should default to Credit for unknown method");
        assertNull(Payment.generateMethod(null), "Should return null for null input");
    }

    @Test
    void testGetBookingID() {
        assertEquals(booking.getBookingID(), payment.getBookingID(), "Booking ID should match");
        Payment noBookingPayment = new Payment(5.0, null, new Debit(), Payment.PaymentType.DEPOSIT);
    ...
    void testRefundPaymentFromCsv() {
        ...
        Payment refundPayment = new Payment(paymentId, booking, -5.0, new Credit(), 
        ...
        assertTrue(refundPayment.getMethod() instanceof Credit, "Method should be Credit");
    }
    ...
    void testFinalPaymentFromCsv() {
        ...
        Payment finalPayment = new Payment(paymentId, finalBooking, 5.0, new Credit(), 
        ...
        assertTrue(finalPayment.getMethod() instanceof Credit, "Method should be Credit");
    }
}